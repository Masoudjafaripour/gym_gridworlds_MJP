...
def eps_greedy_probs(Q_state, eps):
    ...
    while tot_steps < max_steps:
        ...
        while not done and tot_steps < max_steps: #
            ...
            # Expected SARSA: TD Target
                ...
                expected_value = np.dot(eps_greedy_probs(Q[next_state], eps), Q[next_state])
            ...
            if tot_steps % 100 == 0:
                ...
                if alg == "QL":
                    pi = eps_greedy_probs(Q[state], 0)

                # SARSA: Epsilon-greedy policy (same as the exploration policy)
                elif alg == "SARSA":
                    pi = eps_greedy_probs(Q[state], eps)
                ...
                bellman_Q = bellman_q(pi, gamma = 0.9) # 0.9 or 0.99 ??
